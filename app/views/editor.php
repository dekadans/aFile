...
<head>
    ...
    <title><?= $editableFile->getName() ?></title>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="#" id="BrandHome"><?= $editableFile->getName() ?></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                <a id="EditorPreviewToggle" class="nav-item nav-link <?= $editableFile->hasPreview() ? '' : 'd-none' ?>" href="#">
                    <i class="fas fa-search"></i>
                    <?= $lang->translate('EDITOR_TOGGLE_PREVIEW') ?>
                </a>
                <a id="EditorDownload" class="nav-item nav-link" href="<?= $editableFile->getForceDownloadLink() ?>">
...
<div class="container-fluid editor-preview <?= $openInPreview ? '' : 'd-none' ?>">
</div>

<div id="EditorContainer" class="<?= $openInPreview ? 'd-none' : '' ?>">
    <textarea id="EditorTextarea" data-fileid="<?= $editableFile->getId() ?>" spellcheck="false" <?= $editableFile->isWritable() ? '' : 'readonly' ?>><?= $text ?></textarea>
</div>
</body>
</html>